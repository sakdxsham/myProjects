...
#remove this part
roseTrain1<-ROSE(salarymorethan50k ~ ., data = train1,seed =111)$data
table(roseTrain1$salarymorethan50k)

roseTrain2<-ROSE(salarymorethan50k ~ ., data = train2,seed =111)$data
table(roseTrain2$salarymorethan50k)

roseTrain3<-ROSE(salarymorethan50k ~ ., data = train3,seed =111)$data
table(roseTrain3$salarymorethan50k)

levels(roseTrain1$native_country) <- levels(train2$native_country)
levels(roseTrain2$native_country) <- levels(train2$native_country)
levels(roseTrain3$native_country) <- levels(train2$native_country)
